    ...
    >
      <div class="col-span-1 md:col-span-1 lg:col-span-1">
        <div class="flex flex-col h-full">
          <UserProfileGameCard :dorp-down="dropDown" />
          <div v-if="dropDown">
            <StartedMatchList />
          </div>
        </div>
      ...
      >
        <div v-if="!isMobile">
          <div class="lg:max-w-full max-w-md">
            <p class="lg:text-3xl text-sm p-2 px-5 font-semibold text-center bg-gray-200 rounded text-black flex items-center justify-center">
